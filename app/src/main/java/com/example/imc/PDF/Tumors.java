...
public class Tumors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tumors);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, outputURL, null, new Response.Listener<JSONObject>()
        {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    JSONArray jsonArray = response.getJSONArray("Tumors");
...
*/
        ...
        MySingleton.getInstance(Tumors.this).addToReqeustQueue(jsonObjectRequest);
    ...
    public void check_send_MN(){
        ...
        progressDialog = new ProgressDialog(Tumors.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL+InputMedicalN+URL2+InputNatId, null
            ...
            public void onResponse(JSONObject response)
            {
                ...
                try {
                    ...
                    Intent intent = new Intent(Tumors.this, Home.class);
...
*/
    public void NewAlert() {
        ...
        final AlertDialog builder = new AlertDialog.Builder(Tumors.this).create();
        builder.setCancelable(false);
